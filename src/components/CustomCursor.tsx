...
export const CustomCursor = () => {
  ...
  return (
    <>
      ...
      {/* Outer Ring */}
      <motion.div
        className="fixed top-0 left-0 w-8 h-8 border border-white/40 rounded-full pointer-events-none z-[99] shadow-[0_0_15px_rgba(255,255,255,0.1)] backdrop-blur-sm"
        animate={{
